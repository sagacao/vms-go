    ...
    <div class="table">
        <div class="app-container">
            ...
            <el-table :data="data" border class="table">
                <el-table-column prop="productId" label="产品ID" width="220" sortable>
                </el-table-column>
                <el-table-column prop="count" label="付费人次" width="220" sortable>
                </el-table-column>
                <el-table-column prop="sum" label="付费人数" width="220" sortable>
                </el-table-column>
            </el-table>
...
export default {
    ...
    methods: {
        ...
        handleSearch() {
            ...
            this.$store.dispatch('svrmgr/GetPayPlayerSum', { user, page, channel, stime, etime}).then((res) => {
                if (res.list) {
